...
public class RecviewadapterFood extends  RecyclerView.Adapter<RecviewadapterFood.MyViewHolderF> {
    ...
    public RecviewadapterFood(Context mContext, List<Food> mData) {
